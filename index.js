    ...
    if (name === "help") {
			...
			.addFields(
		{
			name: "Working commands",
				value:
			"**Code Runner**\n" +
			"• ` /run ` — Execute Java code (Judge0)\n\n" +
			"**Moderation**\n" +
			"• ` /clear amount ` — Delete up to 100 messages\n\n" +
			"**Logging**\n" +
			"• ` /setlogs channel ` — Set the logs channel (admin)\n" +
			"• ` /genlog ` — Generate and send a JSON log (admin)\n\n" +
			"**Info**\n" +
			"• ` /help ` — Show this message",
      }
    )
    .setFooter({ text: "Logs are kept in memory and reset when the bot restarts." });
